...
FurnaceRecipes::FurnaceRecipes()
{
	...
	addFurnaceRecipe(Tile::birchTrunk->id,  ItemInstance(Item::coal, 1, CoalItem::CHAR_COAL));
	addFurnaceRecipe(Tile::spruceTrunk->id, ItemInstance(Item::coal, 1, CoalItem::CHAR_COAL));
